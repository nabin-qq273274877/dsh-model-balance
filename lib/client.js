	...
	factory: (require) => {
		...
		function CoinIcon() {
		  return (0, import_jsx_runtime.jsx)(
		    ...
		    (0, import_jsx_runtime.jsx)("circle", { cx: 7, cy: 7, r: 6.1, fill: "none", stroke: "currentColor", strokeWidth: 1.2 }),
		...
		function WarnIcon() {
		  return (0, import_jsx_runtime.jsx)(
		    ...
		    (0, import_jsx_runtime.jsx)("path", { d: "M7 5.8v2.6", stroke: "currentColor", strokeWidth: 1.2, strokeLinecap: "round" }),
		    (0, import_jsx_runtime.jsx)("circle", { cx: 7, cy: 10, r: 0.7, fill: "currentColor" })
		  );
		}
		...
		function BalancePill(props) {
		  ...
		  if (query.status === "idle" || query.status === "loading") {
		    return (0, import_jsx_runtime.jsx)(
		      ...
		      (0, import_jsx_runtime.jsx)("span", { className: CLS.icon }, (0, import_jsx_runtime.jsx)(CoinIcon, {})),
		      (0, import_jsx_runtime.jsx)("span", {}, t("pill.querying"))
		    );
		  }
		  if (query.status === "error") {
		    return (0, import_jsx_runtime.jsx)(
		      ...
		      (0, import_jsx_runtime.jsx)("span", { className: CLS.icon }, (0, import_jsx_runtime.jsx)(WarnIcon, {})),
		      (0, import_jsx_runtime.jsx)("span", {}, t("pill.error"))
		    );
		  }
		  ...
		  if (value.queryable === false) {
		    return (0, import_jsx_runtime.jsx)(
		      ...
		      (0, import_jsx_runtime.jsx)("span", { className: CLS.icon }, (0, import_jsx_runtime.jsx)(WarnIcon, {})),
		      (0, import_jsx_runtime.jsx)("span", {}, t("pill.unqueryable"))
		    );
		  }
		  if (value.kind === "quota") {
		    ...
		    return (0, import_jsx_runtime.jsx)(
		      ...
		      (0, import_jsx_runtime.jsx)("span", { className: CLS.icon }, (0, import_jsx_runtime.jsx)(GaugeIcon, {})),
		      (0, import_jsx_runtime.jsx)("span", {}, quotaText)
		    );
		  }
		  ...
		  return (0, import_jsx_runtime.jsx)(
		    ...
		    (0, import_jsx_runtime.jsx)("span", { className: CLS.icon }, (0, import_jsx_runtime.jsx)(CoinIcon, {})),
		    (0, import_jsx_runtime.jsx)("span", {}, balanceText)
		  );
		}
		var zh = {
		  "pill.querying": "\u67E5\u8BE2\u4E2D\u2026",
